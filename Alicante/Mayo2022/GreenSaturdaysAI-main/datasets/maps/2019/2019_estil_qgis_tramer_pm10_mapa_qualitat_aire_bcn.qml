...
Accept-Ranges: bytes
ETag: "1599416183.37-18701"
Last-Modified: Sun, 06 Sep 2020 18:16:23 GMT
Content-Range: bytes 0-18700/18701
...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingHints="1" readOnly="0" version="3.14.15-Pi" maxScale="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 type="categorizedSymbol" enableorderby="0" forceraster="0" attr="Rang" symbollevels="0">
    <categories>
      ...
      <category value="> 40 µg/m³" render="true" symbol="3" label="> 40 µg/m³"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="line" name="1" clip_to_extent="1" force_rhr="0">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="128,191,178,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol alpha="1" type="line" name="2" clip_to_extent="1" force_rhr="0">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="194,231,0,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;PM10 18 def&quot;">
    <columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="PM10 18 c"/>
    <field editable="1" name="PM10 2018"/>
