...
(function($, window, document) {
	...
	_oExt.oJUIClasses = {
		/* Two buttons buttons */
		"sPagePrevEnabled": "fg-button ui-state-default1 ui-corner-left",
		"sPagePrevDisabled": "fg-button ui-state-default1 ui-corner-left ui-state-disabled1",
		"sPageNextEnabled": "fg-button ui-state-default1 ui-corner-right",
		"sPageNextDisabled": "fg-button ui-state-default1 ui-corner-right ui-state-disabled1",
		"sPageJUINext": "ui-icon ui-icon-circle-arrow-e",
		"sPageJUIPrev": "ui-icon ui-icon-circle-arrow-w",
		
		/* Full numbers paging buttons */
		"sPageButton": "fg-button ui-state-default1",
		"sPageButtonActive": "fg-button ui-state-default1 ui-state-disabled1",
		"sPageButtonStaticDisabled": "fg-button ui-state-default1 ui-state-disabled1",
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.aaSorting = [ [0, 'asc', 0] ];
                        ...
                        /*aumenta milton para enviar el tama�o maximo de la tabla	 */
                         this.max_height = 390;
                         /*********************/
			/*
		...
		this.fnOpen_aux = function( nTr, sHtml, sClass )
		{
			/* Find settings from table node */
			var oSettings = _fnSettingsFromNode( this[_oExt.iApiIndex] );
		...
		function _fnInitalise ( oSettings )
		{
			...
			_fnAddOptionsHtml( oSettings );
                        _fnAddOptionsHtml_detalle( oSettings ); /*Milton Aguilera (Aumenta llamada a la nueva funcion)*/
			...
			if ( oSettings.oFeatures.bServerSide )
			{
				...
				if ( typeof oSettings._bInitComplete == 'undefined' )
				{
					_fnInitComplete( oSettings );
                        ...
                        /*19-11-2010
                       *Milton Aguilera
                       *Aumenta codigo a la libreria que para que el body d la tabla se ajuste automaticamnete si es necesario o si es muy grande se fije en el max height
                       **/
                       /*15-12-2010
                       *Milton Aguilera
                       *Aumenta > para q coga solo el body de la tabla seleccionada
                       **/
                      $('#'+oSettings.sTableId+' >tbody').height("100%");
                      if($('#'+oSettings.sTableId+' >tbody').height()>=oSettings.max_height){
                          $('#'+oSettings.sTableId+' >tbody').height(oSettings.max_height+"px");
                      }
		}
		 ...
		 * Inputs:   object:oSettings - dataTables settings object
		 */
                function _fnAddOptionsHtml_detalle ( oSettings ) /*Milton Aguilera (Aumento un div interno que nos ayuda a controlar el tama�o de la tabla)*/
                {
             /*
                  ...
                  nWrapper.className = 'dataTables_wrapper_detalle';
                  if ( oSettings.sTableId !== '' )
                  {
                    nWrapper.setAttribute( 'id', oSettings.sTableId+'_wrapper_detalle' );
                  }
		...
		return this.each(function()
		{
			...
			if ( typeof oInit != 'undefined' && oInit !== null )
			{
				...
				_fnMap( oSettings, oInit, "bJQueryUI", "bJUI" );
                                /*aumenta milton*/
                                _fnMap( oSettings, oInit, "max_height" );
                                /****************************/
			...
			if ( bInitHandedOff === false )
			{
				_fnInitalise( oSettings );
                                /*15-12-2010
                               *Milton Aguilera
                               *Aumenta que aparezca la tabla si un caso esat oculta
                               **/
                                $('#'+oSettings.sTableId).show();
			}
		});
	};
