...
# html_button_login = (
#     html_css_login
#     + f"<a href='{login_link}' class='button-login' target='_self'>Iniciar Sesión</a>"
# )

html_css_login = '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">'
html_button_login = (
    html_css_login
    + f"""<a href='{login_link}' 
    class='button-login' 
